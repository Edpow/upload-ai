    ...
    <div className='min-h-screen flex flex-col'>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p>Lembre-se: você pode utilizar a variável <code className='text-violet-400'>{'{transcription}'}</code> no seu prompt para adicionar conteúdo da transcrição no video.</p>
        </div>
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            ...
            <div className='space-y-1'>
              ...
              placeholder='Inclua palavras-chave mencionadas no vídeo deparadas por vígula (,)'
              />
            </div>
          </form>
        </aside>
